...
namespace RGB {
    ...
    void get_random_RGB_from_HSV(float &r, float &g, float &b) {
        QColor c = QColor::fromHsvF((float) (rand()) / (float) (RAND_MAX),
                                    0.3f + 0.5f * (float) (rand()) / (float) (RAND_MAX),
                                    0.5f + 0.5f * (float) (rand()) / (float) (RAND_MAX));
    ...
    void get_random_RGB_from_HSV(float &r, float &g, float &b, float H) {
        QColor c = QColor::fromHsvF(H, 0.3f + 0.5f * (float) (rand()) / (float) (RAND_MAX),
                                    0.5f + 0.5f * (float) (rand()) / (float) (RAND_MAX));
